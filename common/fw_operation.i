# 0 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 0 "<command-line>" 2
# 1 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.c"





# 1 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.h" 1
# 9 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.h"
# 1 "/home/sri/hailort-drivers/linux/pcie/../../common/hailo_resource.h" 1
# 9 "/home/sri/hailort-drivers/linux/pcie/../../common/hailo_resource.h"
...
# 10 "/home/sri/hailort-drivers/linux/pcie/../../common/hailo_resource.h" 2
...
# 10 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.h" 2
...
# 7 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.c" 2
...
# 9 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.c" 2


# 1 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/linux/bug.h" 1




# 1 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/arch/arm64/include/asm/bug.h" 1
# 12 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/arch/arm64/include/asm/bug.h"
# 1 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/arch/arm64/include/asm/asm-bug.h" 1
# 13 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/arch/arm64/include/asm/bug.h" 2
# 26 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/arch/arm64/include/asm/bug.h"
# 1 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/asm-generic/bug.h" 1





# 1 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/linux/instrumentation.h" 1
# 7 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/asm-generic/bug.h" 2
# 24 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/asm-generic/bug.h"
struct warn_args;
struct pt_regs;
...
# 90 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/asm-generic/bug.h"
...
# 27 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/arch/arm64/include/asm/bug.h" 2
# 6 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/linux/bug.h" 2
...
struct pt_regs;
# 34 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/linux/bug.h"
...
# 80 "/usr/src/linux-headers-6.12.47+rpt-common-rpi/include/linux/bug.h"
...
# 12 "/home/sri/hailort-drivers/linux/pcie/../../common/fw_operation.c" 2
    ...
    struct hailo_d2h_notification *notification)
{
    ...
    if ((0x640 + 0x640) > resource->size) {
        return -22;
    }

    notification_resource.address = resource->address + (0x640 + 0x640),
...
static inline __attribute__((__gnu_inline__)) __attribute__((__unused__)) __attribute__((patchable_function_entry(0, 0))) size_t calculate_log_ready_to_read(FW_DEBUG_BUFFER_HEADER_t *header)
{
    ...
    if (chip_offset >= host_offset) {
        ...
        ready_to_read = ((4*1024) - sizeof(FW_DEBUG_BUFFER_HEADER_t)) - (host_offset - chip_offset);
    }
...
long hailo_read_firmware_log(struct hailo_resource *fw_logger_resource, struct hailo_read_log_params *params)
{
    ...
    if (params->buffer_size > (sizeof(params->buffer) / sizeof((params->buffer)[0]) + ((int)(sizeof(struct { int:(-!!(__builtin_types_compatible_p(typeof((params->buffer)), typeof(&(params->buffer)[0])))); }))))) {
        return -22;
    }
    ...
    ready_to_read = ({ __auto_type __UNIQUE_ID_x_18 = (ready_to_read); __auto_type __UNIQUE_ID_y_19 = (params->buffer_size); do { __attribute__((__noreturn__)) extern void __compiletime_assert_20(void) __attribute__((__error__("min""(""ready_to_read"", ""params->buffer_size"") signedness error"))); if (!(!(!(((((typeof(__UNIQUE_ID_x_18))(-1)) < ( typeof(__UNIQUE_ID_x_18))1)? (2+(__builtin_constant_p((long)(ready_to_read)>=0) && ((long)(ready_to_read)>=0))):(1+2*(sizeof(__UNIQUE_ID_x_18)<4))) & ((((typeof(__UNIQUE_ID_y_19))(-1)) < ( typeof(__UNIQUE_ID_y_19))1)? (2+(__builtin_constant_p((long)(params->buffer_size)>=0) && ((long)(params->buffer_size)>=0))):(1+2*(sizeof(__UNIQUE_ID_y_19)<4))))))) __compiletime_assert_20(); } while (0); ((__UNIQUE_ID_x_18) < (__UNIQUE_ID_y_19) ? (__UNIQUE_ID_x_18) : (__UNIQUE_ID_y_19)); });


    read_offset = sizeof(debug_buffer_header) + debug_buffer_header.host_offset;

    if (((4*1024) - sizeof(FW_DEBUG_BUFFER_HEADER_t)) <= debug_buffer_header.host_offset + ready_to_read) {
        size_to_read = ((4*1024) - sizeof(FW_DEBUG_BUFFER_HEADER_t)) - debug_buffer_header.host_offset;
    ...
    hailo_resource_write32(fw_logger_resource, __builtin_offsetof(FW_DEBUG_BUFFER_HEADER_t, host_offset),
...
{
    long err = 0;
    struct hailo_resource log_resource = {resource->address, (4*1024)};

    if (HAILO_CPU_ID_CPU0 == params->cpu_id) {
        log_resource.address += (8*1024);
    } else if (HAILO_CPU_ID_CPU1 == params->cpu_id) {
        log_resource.address += ((8*1024) + (4*1024));
    } else {
        return -22;
    }
